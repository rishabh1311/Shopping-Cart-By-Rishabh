...
<html>
    <head>
        ...
        <title>Rishabh Sahu Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Shopping Cart By Rishabh</h1>
                    <p>No need to hunt around, We have the best cameras, most classic watches and finest shirts for you.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <a href="https://Rishabh Sahu.in">Rishabh Sahu</a> Store. All Rights Reserved.</p>
                   <p>This website is developed by Rishabh Sahu</p>
               </center>
               </div>
           </footer>
        </div>
